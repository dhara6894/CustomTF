...
Pod::Spec.new do |s|
  s.name             = 'SpaceText'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SpaceText.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/dhara6894/SpaceText'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'dhara6894' => 'dhara.patel@solutionanalysts.com' }
  s.source           = { :git => 'https://github.com/dhara6894/SpaceText.git', :tag => s.version.to_s }
